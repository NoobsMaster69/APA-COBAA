...
class ResepController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // validasi jumlah kosong dengan cara foreach
        dd($jumlah);
        foreach ($jumlah as $key => $value) {
            if ($key == '' || $key == null) {
                Alert::warning('Jumlah bahan yang dipilih', 'Tidak boleh kosong!');
                return redirect()->route('resep.create');
            }
            ...
            if (is_numeric($value)) {
                ...
                Alert::warning('Jumlah harus angka', 'Agar dapat melanjutkan!');
                return redirect()->route('resep.create');
            }
        }
    }
