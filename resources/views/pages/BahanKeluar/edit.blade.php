...
@section('subhead')
<title>Edit Data Pemakaian - Bread Smile</title>
@endsection
        ...
        <div class="intro-y box px-10 py-5">
            <form action="{{ route('bahanKeluar.update', $bahanKeluar->id_bahanKeluar) }}" method="POST">
                ...
                <div class="mt-5">
                    ...
                    <input type="number" class="form-control @error('jumlah') is-invalid @enderror col-6" name="jumlah" id="jumlah" value="{{ old('jumlah', $bahanKeluar->jumlah) }}" required>
                    @error('nm_bahan')
