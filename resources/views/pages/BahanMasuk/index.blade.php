...
@section('subhead')
    <title>Data Bahan Masuk - Bread Smile</title>
@endsection

@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Data Bahan Masuk Layout</h2>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <a class="flex items-center text-danger" href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete-confirmation-modal{{ $bahan->kd_bahan }}">
                                        <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete
                                    </a>
                            <!-- BEGIN: Delete Confirmation Modal -->
                                <div id="delete-confirmation-modal{{ $bahan->kd_bahan }}" class="modal" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-body p-0">
                                                <div class="p-5 text-center">
                                                    <i data-feather="x-circle" class="w-16 h-16 text-danger mx-auto mt-3"></i>
                                                    <div class="text-3xl mt-5">Yakin Gak KONTOL</div>
                                                    <div class="text-slate-500 mt-2">Mau apa hapus data {{ $bahan->nm_bahan }}  KONTOL!!! <br>KALAU DI HAPUS ILANG PERMANENT  NGENTOD JANGAN ASAL HAPUS!!.</div>
                                                </div>
