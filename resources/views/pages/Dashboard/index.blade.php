            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 mt-8">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y" >
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-slate-500 mt-1">apa coba</div>
                                </div>
                            </div>
                        </a>
                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-slate-500 mt-1">Sopir Yang Tersedia</div>
                                </div>
                            </div>
                        </div>
                    </div>
