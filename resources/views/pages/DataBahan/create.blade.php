...
@section('subcontent')
    ...
    <div class="intro-y box p-5 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            <!-- BEGIN: Form Layout -->
            <form class="validate-form" action="{{ route('dataBahan.store') }}" method="POST">
                @csrf
            <div class="intro-y box p-5">
                ...
                <div>
                    ...
                    <input name="nm_bahan" id="nm_bahan" type="text"  class="form-control w-full" placeholder="Input Nama Bahan" minlength="3" required>
                </div>
                <div class="mt-3">
                <div>
                    <label for="harga_beli" class="form-label"> Harga Beli </label>
                    <input name="harga_beli" id="harga_beli" type="text" class="form-control w-full" placeholder="Input text">
                </div>
                <div class="mt-3">
                <div>
                    ...
                    <div class="relative mt-1 rounded-md shadow-sm">
                      ...
                      <input name="stok" id="stok" type="text" class="block w-full rounded-md border-gray-300 pl-7 pr-12 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Input Stok">
                    ...
                    '<div class="input-form mt-3">
                        ...
                        <textarea  name="ket" id="ket" class="form-control"  placeholder="Type your comments" minlength="10" required></textarea>
                    </div>'
                  </div>
