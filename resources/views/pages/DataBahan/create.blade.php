    ...
    <div class="intro-y col-span-12 lg:col-span-6">
        ...
        <form class="" action="{{ route('dataBahan.store') }}" method="POST">
            ...
            <div class="mt-3">
                ...
                <input name="nm_bahan" id="nm_bahan" type="text" class="form-control w-full" placeholder="Masukkan Nama Bahan" minlength="3" value="{{ old('nm_bahan') }}" required>
            </div>
            <div class=" mt-3">
                <label for="harga_beli" class="form-label"> Harga Beli </label>
                <input name="harga_beli" id="harga_beli" type="number" class="form-control w-full" placeholder="Masukkan Harga Beli" value="{{ old('harga_beli') }}" required>
            </div>
            <div class="mt-3">
