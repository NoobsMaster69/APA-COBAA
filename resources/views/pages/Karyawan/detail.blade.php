    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h2 class="font-medium text-base mr-auto">Detail Data</h2>
            </div>
            <!-- END: Modal Header -->
            <!-- BEGIN: Modal Body -->
                    ...
                    <div class="intro-y col-span-12 md:col-span-12 lg:col-span-12 border-2 border-slate-200/60 rounded-md shadow-lg shadow-slate-900">
                        <div class="box">
                            <div class="flex items-start px-5 pt-5">
                                <div class="w-full flex flex-col lg:flex-row items-center">
                                    ...
                                    <div class="lg:ml-4 text-center lg:text-left mt-3 lg:mt-0">
                                        <a href="" class="font-large font-semibold">{{ $kr->nm_karyawan." | ".$kr->nip }}</a>
                                        <div class="text-slate-500 text-xs mt-0.5">{{ $kr->nm_jabatan }}</div>
                                    </div>
                                </div>
                                {{-- <div class="divide-solid divide-y-2 divide-slate-500"> --}}
                            ...
                            <div class="text-center lg:text-left px-5 pb-5 pt-3">
                                ...
                                <div class="flex items-center justify-center lg:justify-start text-slate-700 mt-1">
                                    <i data-feather="tool" class="w-3 h-3 mr-2"></i> {{ $kr->role }}
                                </div>
                                <div class="flex items-center justify-center lg:justify-start text-slate-700 mt-1">
                                    <i data-feather="calendar" class="w-3 h-3 mr-2"></i> {{ $kr->ttl }}
                                </div>
                                <div class="flex items-center justify-center lg:justify-start text-slate-700 mt-1 mb-3">
                                    <i data-feather="phone" class="w-3 h-3 mr-2"></i> {{ $kr->no_telp }}
                                </div>
                                <div class="border-t border-slate-500"></div>
                                <div class="flex justify-center lg:justify-start text-slate-700 mt-3">
                                    {{-- <i data-feather="navigation" class="w-3 h-3 mr-2"></i> --}}
                                    {{ $kr->alamat }}
                                </div>
            ...
            <div class="modal-footer">
                <button type="button" data-tw-dismiss="modal" class="btn btn-primary">Cancel</button>
            </div>
        </form>
            <!-- END: Modal Footer -->
        </div>
