...
@section('subhead')
<title>Tambah Data Mobil - Bread Smile</title>
@endsection
        ...
        <div class="intro-y box px-10 py-5">
            <form class="" action="{{ route('mobil.store') }}" method="POST">
                ...
                <div class="mt-3">
                    ...
                    <input id="kd_mobil" name="kd_mobil" type="text" value="{{ $kode_otomatis }}" readonly class="form-control w-full">
                </div>
                <div class="mt-5">
                    <label for="merk" class="form-label"> Merk Mobil </label>
                    <input name="merk" id="merk" type="text" class="form-control w-full @error('merk') border-danger @enderror" placeholder="Masukkan Merk Mobil" minlength="3" value="{{ old('merk') }}">
                    @error('merk')
                ...
                <div class="mt-5">
                    ...
                    <input name="plat_nomor" id="plat_nomor" type="text" class="form-control w-full @error('plat_nomor') border-danger @enderror" placeholder="Masukkan Nomor Polisi" value="{{ old('plat_nomor') }}">
                    @error('plat_nomor')
                        <div class="text-danger mt-1">
                            {{ $message }}
                        </div>
