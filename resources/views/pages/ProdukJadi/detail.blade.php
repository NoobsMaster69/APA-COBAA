<script src="https://cdn.tailwindcss.com"></script>
    ...
    <div class="fixed inset-0 z-10 overflow-y-auto">
        ...
        <div class="flex w-full transform text-left text-base transition md:my-8 md:max-w-2xl md:px-4 lg:max-w-4xl">
            ...
            <a href="/produkjadi" type="button" class="absolute top-4 right-4 text-gray-400 hover:text-gray-500 sm:top-8 sm:right-6 md:top-6 md:right-6 lg:top-8 lg:right-8">
            ...
            <div class="grid w-full grid-cols-1 items-start gap-y-8 gap-x-6 sm:grid-cols-12 lg:gap-x-8">
                ...
                <section aria-labelledby="information-heading" class="mt-3">
                    ...
                    <div class="absolute top-10 left-10 text-center sm:static sm:mt-6">
                        <button type="submit" class="flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 py-3 px-8 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50">Edit</button>
                    </div>
                </section>
                </div>
            </div>
