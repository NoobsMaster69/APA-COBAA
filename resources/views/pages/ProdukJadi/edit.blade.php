...
<div class="intro-y box lg:mt-5">
    <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
        <h2 class="font-medium text-base mr-auto">Edit Data Produk</h2>
    </div>
    <form action="{{ route('produkJadi.update', $produkJadi->kd_produk) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="p-5">
            <div class="flex flex-col-reverse xl:flex-row flex-col">
                <div class="flex-1 mt-6 xl:mt-0">
                    <div class="grid grid-cols-12 gap-x-5">
                        <div class="col-span-12 2xl:col-span-6">
                            <div>
                                <label for="update-profile-form-1" class="form-label">Kode Produk</label>
                            ...
                            <div class="mt-3">
                                ...
                                <input type="text" class="form-control" id="stok" name="nm_produk" value="{{ $produkJadi->nm_produk }}" required>
                                @error('nm_produk')
                ...
                <a href="/produkJadi" type="submit" class="btn btn-outline-secondary w-20 mt-3 pr-1">close</a>
