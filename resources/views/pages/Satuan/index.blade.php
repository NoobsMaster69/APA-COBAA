                ...
                <tr class="intro-x">
                    ...
                    <td class="table-report__action">
                        <div class="flex justify-center items-center">
                            ...
                            <button class="flex items-center tooltip text-success mr-2" data-theme="light" title="Edit" data-tw-toggle="modal" data-tw-target="#editSatuan-{{ $sat->id_satuan }}">
                                <i data-feather="check-square" class="w-4 h-4 mr-1"></i>
                            </button>

                            <!-- trigger modal -->
                            <button class="flex items-center tooltip text-danger" data-tw-toggle="modal" data-theme="light" title="Hapus" data-tw-target="#hapus{{ $sat->id_satuan }}">
